...
public class RemoveLike_s {
	public static JSONObject removeLike(String key_user, String id_message) throws JSONException, SQLException, UnknownHostException{
	...
	//	name_user = UserTools.getName(id_user, c);
		...
		MessageTools.removeLike(id_message, id_user, coll);
